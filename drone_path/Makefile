...
SOURCES = \
	__init__.py \
	drone_path.py drone_path_dialog.py

PLUGINNAME = drone_path

PY_FILES = \
	__init__.py \
	drone_path.py drone_path_dialog.py

UI_FILES = drone_path_dialog_base.ui
...
QGISDIR=C:\Users\ABC\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
